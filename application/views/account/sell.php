...
<div class="container">
    ...
    <form enctype="multipart/form-data" action="/items/submititem" method="POST">
        ...
        <div class="form-group row">
            <div class="col-md-6">
                <input required placeholder="Price" class="form-control" type="Number" min=0 step="any" name="price">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-md-6">
                <input required placeholder="Shipping" class="form-control" type="Number" min=0 step="any" name="shipping">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-md-6">
